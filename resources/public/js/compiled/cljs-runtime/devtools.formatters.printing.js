...
var len__4818__auto___27004 = arguments.length;
var i__4819__auto___27005 = (0);
while(true){
if((i__4819__auto___27005 < len__4818__auto___27004)){
args__4824__auto__.push((arguments[i__4819__auto___27005]));

var G__27006 = (i__4819__auto___27005 + (1));
i__4819__auto___27005 = G__27006;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq26964){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26965,G__26966,seq26964__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__26977_SHARP_){
return (!((cljs.core.meta(p1__26977_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26983__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e26984){var _e__25859__auto__ = e26984;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e26986){var _e__25859__auto__ = e26986;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__26991 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__26992 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__26992);

try{var map__26993 = opts;
var map__26993__$1 = cljs.core.__destructure_map(map__26993);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26993__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__26991);
}});
...
var temp__5751__auto___27011 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___27011)){
var managed_print_level_27012 = temp__5751__auto___27011;
var _STAR_print_level_STAR__orig_val__26996_27013 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__26997_27014 = managed_print_level_27012;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__26997_27014);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__26995_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__26995_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__26996_27013);
}} else {
job_fn();
}
