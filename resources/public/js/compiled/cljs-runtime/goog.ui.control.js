...
goog.ui.Control.prototype.getCaption = function() {
  ...
  var caption = typeof content === "string" ? content : Array.isArray(content) ? goog.array.map(content, goog.dom.getRawTextContent).join("") : goog.dom.getTextContent(content);
