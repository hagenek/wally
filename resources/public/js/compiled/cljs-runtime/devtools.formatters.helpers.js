...
var G__26956 = devtools.prefs.pref(v);
v = G__26956;
continue;
} else {
return v;
...
}catch (e26911){var _e__25859__auto__ = e26911;
return false;
}})();
...
}catch (e26915){var _e__25859__auto__ = e26915;
return false;
}})();
...
}catch (e26919){var _e__25859__auto__ = e26919;
return false;
}}
}
});
...
var vec__26931 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26931,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26931,(1),null);
...
return cljs.core.some((function (p1__26941_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__26941_SHARP_);
}),template);
});
