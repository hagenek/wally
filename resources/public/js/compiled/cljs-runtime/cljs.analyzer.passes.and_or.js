...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__52866){
var map__52867 = p__52866;
var map__52867__$1 = cljs.core.__destructure_map(map__52867);
var ast = map__52867__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52867__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
return cljs.core.boolean$((function (){var and__4210__auto__ = cljs.analyzer.passes.and_or.simple_op_QMARK_(ast);
if(and__4210__auto__){
var G__52869 = (function (){var or__4212__auto__ = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(ast);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
if(cljs.core.truth_((function (){var fexpr__52870 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"var","var",-769682797),null,new cljs.core.Keyword(null,"local","local",-1497766724),null], null), null);
return (fexpr__52870.cljs$core$IFn$_invoke$arity$1 ? fexpr__52870.cljs$core$IFn$_invoke$arity$1(op) : fexpr__52870.call(null,op));
})())){
...
var fexpr__52868 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"seq","seq",-177272256,null),"null",new cljs.core.Symbol(null,"boolean","boolean",-278886877,null),"null"], null), null);
return (fexpr__52868.cljs$core$IFn$_invoke$arity$1 ? fexpr__52868.cljs$core$IFn$_invoke$arity$1(G__52869) : fexpr__52868.call(null,G__52869));
} else {
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__52872_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__52872_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__52907 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"locals","locals",535295783)], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__52907,local);
} else {
return G__52907;
}
});
...
var map__52921 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__52921__$1 = cljs.core.__destructure_map(map__52921);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52921__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52921__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var map__52923 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__52923__$1 = cljs.core.__destructure_map(map__52923);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52923__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
