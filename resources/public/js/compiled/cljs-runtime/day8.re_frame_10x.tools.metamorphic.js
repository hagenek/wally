...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__33210_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__33210_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__33210_SHARP_) <= ending)));
}));
});
...
var G__33262 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return ((cljs.core.not_any_QMARK_((function (p1__33269_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__33269_SHARP_);
...
return cljs.core.assoc_in(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some((function (p1__33297_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app_db_id,p1__33297_SHARP_);
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__33299){
...
var new_state = (function (){var G__33314 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
var G__33314__$1 = (((G__33314 instanceof cljs.core.Keyword))?G__33314.fqn:null);
switch (G__33314__$1) {
case "sub/create":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33314__$1)].join('')));
...
var second_pass = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (all_state,p__33319){
var vec__33320 = p__33319;
var sub_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33320,(0),null);
var sub_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33320,(1),null);
