...
var G__32572 = o;
goog.object.set(G__32572,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__32573 = o;
goog.object.set(G__32573,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__32650__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__32651__i < G__32651__a.length) {G__32651__a[G__32651__i] = arguments[G__32651__i + 0]; ++G__32651__i;}
  args = new cljs.core.IndexedSeq(G__32651__a,0,null);
} 
return G__32650__delegate.call(this,args);};
G__32650.cljs$lang$maxFixedArity = 0;
G__32650.cljs$lang$applyTo = (function (arglist__32652){
var args = cljs.core.seq(arglist__32652);
return G__32650__delegate(args);
});
...
var G__32574 = props;
var G__32574__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32574,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__32574);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32574__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__32575 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32575,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__32575;
}
})(),id_class);
...
var G__32577 = (cljs.core.count(argv) - first_child);
switch (G__32577) {
case (0):
...
var vec__32583 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32583,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32583,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32583,(2),null);
...
var temp__5757__auto___32657 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___32657 == null)){
} else {
var key_32658 = temp__5757__auto___32657;
(jsprops.key = key_32658);
}
...
var temp__5757__auto___32660 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___32660 == null)){
} else {
var key_32661 = temp__5757__auto___32660;
(jsprops.key = key_32661);
}
...
var temp__5757__auto___32662 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___32662 == null)){
} else {
var key_32663 = temp__5757__auto___32662;
(jsprops.key = key_32663);
}
...
var temp__5757__auto___32668 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___32668 == null)){
} else {
var key_32669 = temp__5757__auto___32668;
(jsprops.key = key_32669);
}
...
var temp__5757__auto___32670 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___32670 == null)){
} else {
var key_32671 = temp__5757__auto___32670;
(jsprops.key = key_32671);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32601_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__32601_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__32611 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32611,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32611,(1),null);
...
break;
default:
var G__32681 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__32682 = compiler;
v = G__32681;
compiler = G__32682;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template32628 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template32628 = (function (opts,id,fn_to_element,parse_fn,meta32629){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template32628.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32630,meta32629__$1){
var self__ = this;
var _32630__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template32628(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta32629__$1));
}));

(reagent.impl.template.t_reagent$impl$template32628.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32630){
var self__ = this;
var _32630__$1 = this;
return self__.meta32629;
}));

(reagent.impl.template.t_reagent$impl$template32628.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template32628.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template32628.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template32628.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template32628.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template32628.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta32629","meta32629",1972123062,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template32628.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template32628.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template32628");

(reagent.impl.template.t_reagent$impl$template32628.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template32628");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template32628.
 */
reagent.impl.template.__GT_t_reagent$impl$template32628 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template32628(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta32629){
return (new reagent.impl.template.t_reagent$impl$template32628(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta32629));
});

}

return (new reagent.impl.template.t_reagent$impl$template32628(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
