...
var G__40524 = o;
goog.object.set(G__40524,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__40613__delegate = function (args){
...
while (G__40614__i < G__40614__a.length) {G__40614__a[G__40614__i] = arguments[G__40614__i + 0]; ++G__40614__i;}
  args = new cljs.core.IndexedSeq(G__40614__a,0,null);
} 
return G__40613__delegate.call(this,args);};
G__40613.cljs$lang$maxFixedArity = 0;
G__40613.cljs$lang$applyTo = (function (arglist__40615){
var args = cljs.core.seq(arglist__40615);
return G__40613__delegate(args);
});
...
var G__40525 = o;
goog.object.set(G__40525,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__40616__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__40617__i < G__40617__a.length) {G__40617__a[G__40617__i] = arguments[G__40617__i + 0]; ++G__40617__i;}
  args = new cljs.core.IndexedSeq(G__40617__a,0,null);
} 
return G__40616__delegate.call(this,args);};
G__40616.cljs$lang$maxFixedArity = 0;
G__40616.cljs$lang$applyTo = (function (arglist__40618){
var args = cljs.core.seq(arglist__40618);
return G__40616__delegate(args);
});
...
var G__40531 = props;
var G__40531__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40531,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__40531);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40531__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__40532 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40532,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__40532;
}
})(),id_class);
...
var G__40533 = (cljs.core.count(argv) - first_child);
switch (G__40533) {
case (0):
...
var vec__40534 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40534,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40534,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40534,(2),null);
...
var temp__5757__auto___40620 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___40620 == null)){
} else {
var key_40621 = temp__5757__auto___40620;
(jsprops.key = key_40621);
}
...
var temp__5757__auto___40622 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___40622 == null)){
} else {
var key_40623 = temp__5757__auto___40622;
(jsprops.key = key_40623);
}
...
var temp__5757__auto___40624 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___40624 == null)){
} else {
var key_40625 = temp__5757__auto___40624;
(jsprops.key = key_40625);
}
...
var temp__5757__auto___40626 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___40626 == null)){
} else {
var key_40627 = temp__5757__auto___40626;
(jsprops.key = key_40627);
}
...
var temp__5757__auto___40629 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___40629 == null)){
} else {
var key_40630 = temp__5757__auto___40629;
(jsprops.key = key_40630);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40560_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__40560_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__40561 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40561,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40561,(1),null);
...
var G__40569 = tag;
var G__40569__$1 = (((G__40569 instanceof cljs.core.Keyword))?G__40569.fqn:null);
switch (G__40569__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template40571 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template40571 = (function (opts,id,fn_to_element,parse_fn,meta40572){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template40571.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40573,meta40572__$1){
var self__ = this;
var _40573__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template40571(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta40572__$1));
}));

(reagent.impl.template.t_reagent$impl$template40571.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40573){
var self__ = this;
var _40573__$1 = this;
return self__.meta40572;
}));

(reagent.impl.template.t_reagent$impl$template40571.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template40571.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template40571.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template40571.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template40571.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template40571.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta40572","meta40572",1404324851,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template40571.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template40571.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template40571");

(reagent.impl.template.t_reagent$impl$template40571.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template40571");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template40571.
 */
reagent.impl.template.__GT_t_reagent$impl$template40571 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template40571(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta40572){
return (new reagent.impl.template.t_reagent$impl$template40571(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta40572));
});

}

return (new reagent.impl.template.t_reagent$impl$template40571(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
