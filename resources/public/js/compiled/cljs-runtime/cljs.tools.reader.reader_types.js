...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_38987 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_38987(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_38989 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_38989(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_38991 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_38991(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_38992 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_38992(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_38996 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_38996(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_38997 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_38997(reader);
}
});
...
var G__39026 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__39027 = s.append(c);
c = G__39026;
s = G__39027;
continue;
}
