...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_41679 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_41679(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_41717 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_41717(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_41724 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_41724(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_41726 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_41726(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_41737 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_41737(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_41742 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_41742(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__41633,callback){
var map__41635 = p__41633;
var map__41635__$1 = cljs.core.__destructure_map(map__41635);
var input = map__41635__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41635__$1,new cljs.core.Keyword(null,"code","code",1586293142));
