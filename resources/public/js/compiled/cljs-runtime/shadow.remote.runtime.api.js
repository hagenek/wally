...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_52013 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_52013(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_52014 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_52014(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_52015 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_52015(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_52016 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_52016(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_52017 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_52017(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_52018 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_52018(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__52007,callback){
var map__52008 = p__52007;
var map__52008__$1 = cljs.core.__destructure_map(map__52008);
var input = map__52008__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52008__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52008__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
