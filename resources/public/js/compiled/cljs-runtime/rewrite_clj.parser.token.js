...
return rewrite_clj.reader.read_until(reader,(function (p1__44417_SHARP_){
return ((cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__44417_SHARP_) : allowed_QMARK_.call(null,p1__44417_SHARP_)))) && (rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__44417_SHARP_)));
}));
});
...
var G__44420 = (rewrite_clj.reader.read_string.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.reader.read_string.cljs$core$IFn$_invoke$arity$1(s) : rewrite_clj.reader.read_string.call(null,s));
var G__44421 = s;
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__44420,G__44421) : rewrite_clj.node.token_node.call(null,G__44420,G__44421));
}
});
/**
