...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__29630){
var map__29631 = p__29630;
var map__29631__$1 = cljs.core.__destructure_map(map__29631);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29631__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29631__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29631__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29631__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__29634_29668 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__29635_29669 = null;
var count__29636_29670 = (0);
var i__29637_29671 = (0);
while(true){
if((i__29637_29671 < count__29636_29670)){
var vec__29651_29672 = chunk__29635_29669.cljs$core$IIndexed$_nth$arity$2(null,i__29637_29671);
var k_29673 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29651_29672,(0),null);
var cb_29674 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29651_29672,(1),null);
try{var G__29656_29675 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_29674.cljs$core$IFn$_invoke$arity$1 ? cb_29674.cljs$core$IFn$_invoke$arity$1(G__29656_29675) : cb_29674.call(null,G__29656_29675));
}catch (e29655){var e_29676 = e29655;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_29673,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_29676], 0));
}

var G__29677 = seq__29634_29668;
var G__29678 = chunk__29635_29669;
var G__29679 = count__29636_29670;
var G__29680 = (i__29637_29671 + (1));
seq__29634_29668 = G__29677;
chunk__29635_29669 = G__29678;
count__29636_29670 = G__29679;
i__29637_29671 = G__29680;
continue;
} else {
var temp__5753__auto___29681 = cljs.core.seq(seq__29634_29668);
if(temp__5753__auto___29681){
var seq__29634_29682__$1 = temp__5753__auto___29681;
if(cljs.core.chunked_seq_QMARK_(seq__29634_29682__$1)){
var c__4638__auto___29683 = cljs.core.chunk_first(seq__29634_29682__$1);
var G__29684 = cljs.core.chunk_rest(seq__29634_29682__$1);
var G__29685 = c__4638__auto___29683;
var G__29686 = cljs.core.count(c__4638__auto___29683);
var G__29687 = (0);
seq__29634_29668 = G__29684;
chunk__29635_29669 = G__29685;
count__29636_29670 = G__29686;
i__29637_29671 = G__29687;
continue;
} else {
var vec__29659_29688 = cljs.core.first(seq__29634_29682__$1);
var k_29689 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29659_29688,(0),null);
var cb_29690 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29659_29688,(1),null);
try{var G__29663_29691 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_29690.cljs$core$IFn$_invoke$arity$1 ? cb_29690.cljs$core$IFn$_invoke$arity$1(G__29663_29691) : cb_29690.call(null,G__29663_29691));
}catch (e29662){var e_29692 = e29662;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_29689,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_29692], 0));
}

var G__29693 = cljs.core.next(seq__29634_29682__$1);
var G__29694 = null;
var G__29695 = (0);
var G__29696 = (0);
seq__29634_29668 = G__29693;
chunk__29635_29669 = G__29694;
count__29636_29670 = G__29695;
i__29637_29671 = G__29696;
continue;
}
} else {
}
