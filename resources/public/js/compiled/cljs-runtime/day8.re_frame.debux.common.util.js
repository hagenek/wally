...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__54091){
var vec__54092 = p__54091;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54092,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54092,(1),null);
...
return clojure.zip.zipper((function (p1__54095_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__54095_SHARP_)) || (cljs.core.map_QMARK_(p1__54095_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__54100){
var vec__54101 = p__54100;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54101,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54101,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54107_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__54107_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54106_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54106_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54108_SHARP_){
return (((p1__54108_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__54108_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__54114,mapping){
var map__54115 = p__54114;
var map__54115__$1 = cljs.core.__destructure_map(map__54115);
var state = map__54115__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54115__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54115__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54115__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54113_SHARP_){
var and__4210__auto__ = (p1__54113_SHARP_ instanceof cljs.core.Symbol);
if(and__4210__auto__){
return cljs.core.namespace(p1__54113_SHARP_);
} else {
...
var G__54183 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__54185 = clojure.zip.next(loc);
loc = G__54185;
continue;
}
}
...
var len__4818__auto___54193 = arguments.length;
var i__4819__auto___54194 = (0);
while(true){
if((i__4819__auto___54194 < len__4818__auto___54193)){
args__4824__auto__.push((arguments[i__4819__auto___54194]));

var G__54195 = (i__4819__auto___54194 + (1));
i__4819__auto___54194 = G__54195;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__54136){
var vec__54137 = p__54136;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54137,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq54134){
var G__54135 = cljs.core.first(seq54134);
var seq54134__$1 = cljs.core.next(seq54134);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54135,seq54134__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54140_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54140_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__54142_54200 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54143_54201 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54144_54202 = true;
var _STAR_print_fn_STAR__temp_val__54145_54203 = (function (x__4750__auto__){
return sb__4749__auto__.append(x__4750__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54144_54202);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54145_54203);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54143_54201);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54142_54200);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4749__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54141_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__54141_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__54205 = cljs.core.next(opts__$1);
var G__54206 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__54205;
acc = G__54206;
continue;
} else {
if(typeof f === 'string'){
var G__54207 = cljs.core.next(opts__$1);
var G__54208 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__54207;
acc = G__54208;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__54209 = cljs.core.nnext(opts__$1);
var G__54210 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__54209;
acc = G__54210;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__54212 = cljs.core.next(opts__$1);
var G__54213 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__54212;
acc = G__54213;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54149 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__54149.cljs$core$IFn$_invoke$arity$1 ? fexpr__54149.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54149.call(null,f));
})())){
var G__54216 = cljs.core.next(opts__$1);
var G__54217 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__54216;
acc = G__54217;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54150 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__54150.cljs$core$IFn$_invoke$arity$1 ? fexpr__54150.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54150.call(null,f));
})())){
var G__54219 = cljs.core.nnext(opts__$1);
var G__54220 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__54219;
acc = G__54220;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__54221 = cljs.core.next(opts__$1);
var G__54222 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__54221;
acc = G__54222;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__54152){
var vec__54154 = p__54152;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54154,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54154,(1),null);
...
var G__54158 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__54157 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__54157.cljs$core$IFn$_invoke$arity$1 ? fexpr__54157.cljs$core$IFn$_invoke$arity$1(G__54158) : fexpr__54157.call(null,G__54158));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54160 = quoted_form;
var G__54161 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54160,G__54161) : day8.re_frame.debux.common.util.remove_d.call(null,G__54160,G__54161));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54166 = quoted_form;
var G__54167 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54166,G__54167) : day8.re_frame.debux.common.util.remove_d.call(null,G__54166,G__54167));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__54234__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54169 = quoted_form;
var G__54170 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54169,G__54170) : day8.re_frame.debux.common.util.remove_d.call(null,G__54169,G__54170));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__54238__i < G__54238__a.length) {G__54238__a[G__54238__i] = arguments[G__54238__i + 0]; ++G__54238__i;}
  arg = new cljs.core.IndexedSeq(G__54238__a,0,null);
} 
return G__54234__delegate.call(this,arg);};
G__54234.cljs$lang$maxFixedArity = 0;
G__54234.cljs$lang$applyTo = (function (arglist__54239){
var arg = cljs.core.seq(arglist__54239);
return G__54234__delegate(arg);
});
...
var G__54250 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__54250;
continue;
} else {
...
var G__54252 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__54252;
continue;
} else {
var G__54253 = clojure.zip.next(loc);
loc = G__54253;
continue;
