...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__46482){
var vec__46483 = p__46482;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46483,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46483,(1),null);
...
return clojure.zip.zipper((function (p1__46487_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__46487_SHARP_)) || (cljs.core.map_QMARK_(p1__46487_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__46489){
var vec__46490 = p__46489;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46490,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46490,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46495_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__46495_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46494_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46494_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46496_SHARP_){
return (((p1__46496_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__46496_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__46508,mapping){
var map__46509 = p__46508;
var map__46509__$1 = cljs.core.__destructure_map(map__46509);
var state = map__46509__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46509__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46509__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46509__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46506_SHARP_){
var and__4210__auto__ = (p1__46506_SHARP_ instanceof cljs.core.Symbol);
if(and__4210__auto__){
return cljs.core.namespace(p1__46506_SHARP_);
} else {
...
var G__46575 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46576 = clojure.zip.next(loc);
loc = G__46576;
continue;
}
}
...
var len__4818__auto___46587 = arguments.length;
var i__4819__auto___46588 = (0);
while(true){
if((i__4819__auto___46588 < len__4818__auto___46587)){
args__4824__auto__.push((arguments[i__4819__auto___46588]));

var G__46589 = (i__4819__auto___46588 + (1));
i__4819__auto___46588 = G__46589;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__46526){
var vec__46527 = p__46526;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46527,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq46521){
var G__46522 = cljs.core.first(seq46521);
var seq46521__$1 = cljs.core.next(seq46521);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46522,seq46521__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46542_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46542_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__46548_46590 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__46549_46591 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__46550_46592 = true;
var _STAR_print_fn_STAR__temp_val__46551_46593 = (function (x__4750__auto__){
return sb__4749__auto__.append(x__4750__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__46550_46592);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__46551_46593);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__46549_46591);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__46548_46590);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4749__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46547_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__46547_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__46594 = cljs.core.next(opts__$1);
var G__46595 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__46594;
acc = G__46595;
continue;
} else {
if(typeof f === 'string'){
var G__46596 = cljs.core.next(opts__$1);
var G__46597 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__46596;
acc = G__46597;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__46598 = cljs.core.nnext(opts__$1);
var G__46599 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__46598;
acc = G__46599;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__46600 = cljs.core.next(opts__$1);
var G__46601 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__46600;
acc = G__46601;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46554 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__46554.cljs$core$IFn$_invoke$arity$1 ? fexpr__46554.cljs$core$IFn$_invoke$arity$1(f) : fexpr__46554.call(null,f));
})())){
var G__46602 = cljs.core.next(opts__$1);
var G__46603 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46602;
acc = G__46603;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46555 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__46555.cljs$core$IFn$_invoke$arity$1 ? fexpr__46555.cljs$core$IFn$_invoke$arity$1(f) : fexpr__46555.call(null,f));
})())){
var G__46604 = cljs.core.nnext(opts__$1);
var G__46605 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46604;
acc = G__46605;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__46606 = cljs.core.next(opts__$1);
var G__46607 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46606;
acc = G__46607;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__46557){
var vec__46558 = p__46557;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46558,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46558,(1),null);
...
var G__46566 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__46565 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__46565.cljs$core$IFn$_invoke$arity$1 ? fexpr__46565.cljs$core$IFn$_invoke$arity$1(G__46566) : fexpr__46565.call(null,G__46566));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46568 = quoted_form;
var G__46569 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46568,G__46569) : day8.re_frame.debux.common.util.remove_d.call(null,G__46568,G__46569));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46570 = quoted_form;
var G__46571 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46570,G__46571) : day8.re_frame.debux.common.util.remove_d.call(null,G__46570,G__46571));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__46614__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46572 = quoted_form;
var G__46573 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46572,G__46573) : day8.re_frame.debux.common.util.remove_d.call(null,G__46572,G__46573));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__46614 = function (var_args){
var arg = null;
...
while (G__46615__i < G__46615__a.length) {G__46615__a[G__46615__i] = arguments[G__46615__i + 0]; ++G__46615__i;}
  arg = new cljs.core.IndexedSeq(G__46615__a,0,null);
} 
return G__46614__delegate.call(this,arg);};
G__46614.cljs$lang$maxFixedArity = 0;
G__46614.cljs$lang$applyTo = (function (arglist__46616){
var arg = cljs.core.seq(arglist__46616);
return G__46614__delegate(arg);
});
G__46614.cljs$core$IFn$_invoke$arity$variadic = G__46614__delegate;
return G__46614;
})()
;
});
...
var G__46617 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46617;
continue;
} else {
...
var G__46618 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46618;
continue;
} else {
var G__46619 = clojure.zip.next(loc);
loc = G__46619;
continue;
