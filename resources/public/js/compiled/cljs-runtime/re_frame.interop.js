...
return [(function (){var pred__40679 = cljs.core.instance_QMARK_;
var expr__40680 = reactive_val;
if(cljs.core.truth_((pred__40679.cljs$core$IFn$_invoke$arity$2 ? pred__40679.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__40680) : pred__40679.call(null,reagent.ratom.RAtom,expr__40680)))){
return "ra";
} else {
if(cljs.core.truth_((pred__40679.cljs$core$IFn$_invoke$arity$2 ? pred__40679.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__40680) : pred__40679.call(null,reagent.ratom.RCursor,expr__40680)))){
return "rc";
} else {
if(cljs.core.truth_((pred__40679.cljs$core$IFn$_invoke$arity$2 ? pred__40679.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__40680) : pred__40679.call(null,reagent.ratom.Reaction,expr__40680)))){
return "rx";
} else {
if(cljs.core.truth_((pred__40679.cljs$core$IFn$_invoke$arity$2 ? pred__40679.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__40680) : pred__40679.call(null,reagent.ratom.Track,expr__40680)))){
return "tr";
} else {
return "other";
}
