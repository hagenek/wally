...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__36047,k,f){
var vec__36048 = p__36047;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36048,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36048,(1),null);
var loc = vec__36048;
...
var G__36087 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__36087;
continue;
}
break;
...
var G__36088 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__36088;
continue;
} else {
return zloc__$1;
...
var G__36089 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__36089;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__36067){
var vec__36068 = p__36067;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36068,(0),null);
var map__36071 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36068,(1),null);
var map__36071__$1 = cljs.core.__destructure_map(map__36071);
var path = map__36071__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36071__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__36068;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__36074){
var vec__36075 = p__36074;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36075,(0),null);
var map__36078 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36075,(1),null);
var map__36078__$1 = cljs.core.__destructure_map(map__36078);
var path = map__36078__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36078__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__36075;
if(cljs.core.seq(r)){
...
var path = map__36084__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36084__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36084__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36084__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36084__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
